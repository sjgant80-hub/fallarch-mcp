...
MCP stdio server wrapping `@ai-native-solutions/fallarch-sdk`.

## Install
```bash
claude mcp add fallarch -- npx -y @ai-native-solutions/fallarch-mcp
```
...
- **Discoverable** — indexed on the FallMarket catalog at [sjgant80-hub.github.io/fallmarket/listing.html?id=fallarch-mcp](https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallarch-mcp)
...
- **Companion SDK** (`npm install @ai-native-solutions/fallarch-mcp-sdk`) — programmatic JavaScript API for direct integration.
- **Companion MCP server** (`claude mcp add fallarch-mcp -- npx -y @ai-native-solutions/fallarch-mcp-mcp`) — Model Context Protocol server that any Claude/Cursor/Codex client can invoke as a tool.
- **Companion HTTP API** (`docker run --rm ghcr.io/sjgant80-hub/fallarch-mcp-api`) — containerized REST endpoint for language-agnostic access.
...
- **Registry entry**: https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallarch-mcp
- **Live URL**: https://sjgant80-hub.github.io/fallarch-mcp/
- **Source**: https://github.com/sjgant80-hub/fallarch-mcp
